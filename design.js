...
function updateCircle() {
  var p1Circle = document.getElementById("player").children;
  ...
  var p2Circle = document.getElementById("players").children;
  console.log(p2Circle);
  for (let i = 0; i < p2_arr.length; i++) {
    if (p2_arr[i] % 2 == 0) p2Circle[i].style.backgroundColor = "green";
    else p2Circle[i].style.backgroundColor = "red";
  }
}
